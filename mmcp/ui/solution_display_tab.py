...
class SolutionDisplayTab(QWidget):
    ...
    def __init__(self):
        LOGGER.debug("Initializing SolutionDisplayTab.")
        super().__init__()
    ...
    def display_solution(self, solution_data: SolutionData, solution_time: float):
        ...
        """
        LOGGER.debug("Displaying solution in SolutionDisplayTab.")
    ...
    def copy_to_clipboard(self):
        ...
        """
        LOGGER.debug("Copying solution to clipboard.")
    ...
    def set_filename(self, filename: str, extension: str = ".json"):
        ...
        """
        LOGGER.debug(f"Setting default filename to: {filename}{extension}")
    ...
    def save_to_file(self):
        ...
        """
        LOGGER.debug("Saving solution to file.")
        ...
        if filename:
            LOGGER.debug(f"Saving solution to: {filename}")
            try:
